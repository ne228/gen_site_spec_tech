...
def generate_index(path_to_folders, path_to_generate, title):
    ...
    template = """
     <div>
          <a href="{val}/index.html" class="list-group-item list-group-item-action" aria-current="true">
          <img class="list-item-icon" src="icons/hashtag.svg" alt="hashtag">
          {val}</a>
        </div>
    """
    midle = ""
